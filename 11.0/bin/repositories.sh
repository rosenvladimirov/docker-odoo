...
# shellcheck disable=SC2164
cd ./rosenvladimirov
rr=("l10n-bulgaria" "intrastat-extrastat" "purchase-reporting" "stock-logistics-warehouse" "account-invoice-reporting" "stock-logistics-barcode" "sale-reporting" "account-analytic" "neuro" "intrastat" "website" "stock-logistics-workflow" "maintenance" "product_electrical_properties" "stock-logistics-reporting" "manufacture" "survey" "geospatial" "base_report_to_printer" "account-payment" "e-commerce" "auth_singup_ext" "server-ux" "delivery-carrier" "product-attribute" "account-financial-reporting" "reporting-engine" "reporting-engine-new" "l10n_bg-locales" "social" "edi" "partner-contact" "account-invoicing" "hr" "bank-payment" "purchase-workflow" "report-print-send" "stock-logistics-tracking" "fleet" "web" "sale-workflow" "l10n_gr-locales" "crm" "product-variant" "bank-statement-import" "rma" "delivery_speedy" "account-closing" "knowledge" "server-backend" "account-financial-tools" "currency" "l10n_cy-locales")
