...
# shellcheck disable=SC2164
cd ./rosenvladimirov
rr=("l10n-bulgaria" "intrastat-extrastat" "purchase-reporting" "stock-logistics-warehouse" "account-invoice-reporting" "stock-logistics-barcode" "sale-reporting" "account-analytic" "neuro" "website" "stock-logistics-workflow" "maintenance" "stock-logistics-reporting" "manufacture" "survey" "geospatial" "account-payment" "e-commerce" "auth_singup_ext" "server-ux" "delivery-carrier" "product-attribute" "account-financial-reporting" "reporting-engine" "reporting-engine-new" "l10n_bg-locales" "social" "edi" "partner-contact" "account-invoicing" "hr" "bank-payment" "purchase-workflow" "report-print-send" "stock-logistics-tracking" "fleet" "web" "sale-workflow" "l10n_gr-locales" "crm" "product-variant" "bank-statement-import" "rma" "account-closing" "knowledge" "server-backend" "account-financial-tools" "currency" "l10n_cy-locales")
